...
class Configuration(tk.Toplevel):
	...
	def create_widgets(self):
		...
		#tab 1
		tab1 = ttk.Frame(button_tabs)
		tab2 = ttk.Frame(button_tabs)
		
		button_tabs.add(tab1, text = 'Tab 1')
		button_tabs.add(tab2, text = 'Tab 2')
		
		button_tabs.place(x = 0, y = 0, relwidth = 1, relheight = 1)
